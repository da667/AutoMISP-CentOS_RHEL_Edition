...
declare -a packages=( deltarpm mysql ntpdate neovim gcc git zip rh-git218 httpd24 mod_ssl rh-redis32 rh-mariadb102 libxslt-devel zlib-devel ssdeep-devel rh-php72 rh-php72-php-fpm rh-php72-php-devel rh-php72-php-mysqlnd rh-php72-php-mbstring rh-php72-php-xml rh-php72-php-bcmath rh-php72-php-opcache rh-php72-php-gd rh-python36 haveged devtoolset-7 cmake3 cppcheck gpgme-devel openjpeg-devel gcc-c++ poppler-cpp-devel pkgconfig python-devel redhat-rpm-config rh-ruby24 rubygem-rouge rubygem-asciidoctor zbar-devel opencv-devel );
